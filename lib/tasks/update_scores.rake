task :update_scores => :environment do
  ...
  Vehicle.all.each do |v|
    ...
    if v.air_conditioning || v.power_windows || v.remote_keyless_entry || 
       v.speed_control || v.am_fm_radio || v.wireless_phone_connectivity || 
       v.fully_automatic_headlights || v.variably_intermittent_wipers || 
       v.abs_brakes || v.brake_assist || v.dual_front_impact_airbags ||
       v.electronic_stability || v.security_system || v.traction_control ||
       v.power_steering
      features_score = 100
